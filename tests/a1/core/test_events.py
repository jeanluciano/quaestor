...
from a1.core.events import ClaudeEvent, Event, QuaestorEvent, ToolUseEvent
...
class TestClaudeEvent:
    ...
    def test_claude_event_creation(self):
        ...
        event = ClaudeEvent(type="post_tool_use", data={"tool": "Read", "file_path": "/test.py"})
    ...
    def test_claude_event_to_dict(self):
        ...
        event = ClaudeEvent(type="pre_file_edit", data={"file": "test.py", "action": "edit"})
        data = event.to_dict()
...
class TestQuaestorEvent:
    ...
    def test_quaestor_event_to_dict(self):
        ...
        event = QuaestorEvent(
            type="config_changed", data={"setting": "debug", "value": True}, component="config_manager"
        )
        data = event.to_dict()
