...
class TestIntent:
    ...
    def test_intent_creation(self):
        ...
        intent = Intent(
            intent_type="exploring", confidence=0.85, evidence={"tool_ratio": 0.8, "indicators_matched": 0.9}
        )
    ...
    def test_intent_to_dict(self):
        ...
        intent = Intent(intent_type="implementing", confidence=0.95, evidence={"edit_count": 5})
