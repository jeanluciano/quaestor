...
class A1HookInstaller:
    ...
    def __init__(self, claude_settings_path: Path | None = None):
...
def main():
    ...
    parser.add_argument("action", choices=["install", "uninstall", "check"], help="Action to perform")
    parser.add_argument("--settings-path", type=Path, help="Path to Claude settings.json")
    parser.add_argument("--no-backup", action="store_true", help="Don't backup settings when installing")
