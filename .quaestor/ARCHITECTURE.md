<!-- Generated by Quaestor project-init - Populated with actual project analysis -->
<!-- META:document:architecture -->
<!-- META:version:1.0 -->
<!-- META:ai-optimized:true -->

# Quaestor Project Architecture
...
```yaml
pattern:
  selected: "Dual-System Event-Driven Architecture"
  description: "Modular CLI with core functionality + advanced A1 extension system using event-driven communication and plugin architecture"
  
primary_systems:
  core_quaestor:
    pattern: "Layered CLI Architecture"
    layers: ["CLI Commands", "Core Services", "Automation Engine", "Asset Management"]
    
  a1_advanced:
    pattern: "Event-Driven Extension System"
    components: ["Event Bus", "Extensions", "Learning System", "Advanced Utilities"]
```
...
```yaml
components:
  - name: "CLI Layer (quaestor.cli)"
    responsibility: "Command-line interface with Typer, handles user commands and routing"
    dependencies: ["typer", "rich", "core services"]
    
  - name: "Core Services (quaestor.core)"
    responsibility: "Project analysis, configuration, template engine, validation"
    dependencies: ["PyYAML", "pathlib", "project metadata"]
    
  - name: "Automation Engine (quaestor.automation)"
    responsibility: "Hook system, workflow enforcement, intelligent automation"
    dependencies: ["core services", "rule engine"]
    
  - name: "A1 Event System (a1.core)"
    responsibility: "Event bus, event store, context management for advanced features"
    dependencies: ["asyncio", "event definitions"]
    
  - name: "A1 Extensions (a1.extensions)"
    responsibility: "Hooks, persistence, prediction, state management, workflow detection"
    dependencies: ["a1.core", "learning system"]
